...
function About() {
    ...
    <section className="aboutIntro">
      ...
      <div className="educationSection">
        ...
        <h3>[BA Honours Creative Digital Media]</h3>
        <h3>[2020 - 2024]</h3>
        ...
        <details className="collapsible">
          ...
          <div className='collapsibleContent'>
          <h3>[Specialisation in Immersive Design]</h3>
          <h3>[2022]</h3>
        ...
        <details className="collapsible">
          ...
          <div className='collapsibleContent'>
          <h3>[Masters in Interaction and Experience Design]</h3>
          <h3>[2025]</h3>
